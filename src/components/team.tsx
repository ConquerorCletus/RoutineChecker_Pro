...
const Team = () => {
  return (
    <section
      id='Team'
      className='pt-20 flex items-center bg-stone-50 xl:h-screen font-poppins dark:bg-gray-800'
    >
        ...
        <div className='flex flex-wrap justify-center mb-10 lg:mb-20'>
          <div className='w-full px-6 mb-16 sm:w-1/2 lg:w-1/3 lg:mb-0'>
            <div>
              ...
              <a
                href='#'
                className='inline-block w-full p-6 transition duration-200 bg-blue-800 rounded-lg hover:bg-blue-600'
              >
                <h2 className='mb-2 text-3xl font-bold text-white'>
                  Nwafor Chibuike
                </h2>
                <p className='mb-4 text-lg font-semibold text-gray-100'>
                  Frontend Developer
                </p>
                <div className='flex justify-end'>
                  <svg
                    ...
                    height='16'
                    fill='currentColor'
                    className='w-6 h-6 text-gray-100 bi bi-arrow-right'
                    viewBox='0 0 16 16'
                  >
                    <path
                      fillRule='evenodd'
